...
<table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff; border-radius:8px; overflow:hidden;">
    ...
    <!-- HEADER -->
    <tr>
        <td style="padding:0; text-align:center; border-bottom:1px solid #eee;">
            <img src="https://cejzambia.org/wp-content/uploads/2023/01/epd.jpeg" 
                 width="100%" 
                 style="display:block;" 
                 alt="EPD Logo">
            <h2 style="margin:15px 0; font-size:18px; color:#333;">
                Environmental Protection Dialogue - EPD2026
            </h2>
        </td>
    </tr>
