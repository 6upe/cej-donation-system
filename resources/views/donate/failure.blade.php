...
<body>
    ...
    <div class="container d-flex justify-content-center align-items-center vh-100">
        <div class="col-md-6">
            <div class="donation-card text-center">
                ...
                <h3 class="text-danger mt-2 mb-2">Donation Failed</h3>
                <img src="https://media.lordicon.com/icons/wired/flat/38-error-cross-simple.gif" width="50%" style="margin: 0 auto;" alt="">
                <a href="https://donate.cejzambia.org">Try Again</a>
                <a href="https://cejzambia.org">Home</a>
            </div>
        </div>
    </div>
    ...
    <script>
        document.getElementById('other-amount-btn').addEventListener('click', function() {
            document.getElementById('other-amount-input').style.display = 'block';
        });
    </script>
</body>
</html>
