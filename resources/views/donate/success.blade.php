    ...
    <div class="container d-flex justify-content-center align-items-center vh-100">
        <div class="col-md-6">
            <div class="donation-card text-center">
                ...
                <h3 class="text-success mt-2 mb-2">Donation Successful!</h3>
                
                <img src="https://miro.medium.com/v2/resize:fit:1400/1*Tt1d7z553M0-vKfo0N9Krw.gif" width="50%" style="margin: 0 auto;" alt="Success GIF">
                
                <div class="transaction-details mt-3">
                   
                    <p><strong>Note:</strong> An invoice has been sent to your email.</p>
